...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \item[\emph{To RQ4 (answered last):}] ensemble trees are the strongest family on multimodal tabular telemetry, which is also \emph{why a lightweight normalised linear model---not a tree---is the right detector for the online setting} established by RQ3.
  \end{itemize}
