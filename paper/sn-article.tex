...
instrumented nine-service mesh (\texttt{gateway}$\rightarrow$\texttt{movie}$\rightarrow$\{\texttt{actor}$\times N$,
\texttt{review}\}, plus \texttt{user}/\texttt{search}/\texttt{recommendation}$\rightarrow$\texttt{catalog}); Chaos Mesh injects timestamped faults.
